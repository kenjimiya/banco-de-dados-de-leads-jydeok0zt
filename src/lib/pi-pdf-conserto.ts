...
<table class="info-table">
  ...
  ${d.billingDate ? `<tr><td class="label-blue">FATURAMENTO:</td><td colspan="3">${d.billingDate}</td></tr>` : ''}
...
${order.notes ? `<div class="section-title-blue">Observações</div><div style="border:1px solid #ccc;padding:4px 6px;margin-bottom:6px;white-space:pre-wrap;font-size:12px">${order.notes}</div>` : ''}
<div style="margin-top:20px;text-align:center;color:#6b7280;font-size:10px;border-top:1px solid #e5e7eb;padding-top:6px">Sigma Transformadores Ltda - Pedido Interno de Conserto Gerado Eletronicamente</div>
</body></html>`
