...
.pi-date{font-size:12px;color:#6b7280;margin-top:2px}
...
<div class="pi-header">
  ...
  ${order.billing_date ? `<div class="pi-date">Faturamento: ${new Date(order.billing_date).toLocaleDateString('pt-BR')}</div>` : ''}
</div>
