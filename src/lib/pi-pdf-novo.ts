...
.pi-op-type{font-size:13px;font-weight:bold;color:#1e40af;margin-top:4px;text-transform:uppercase}
.pi-date{font-size:11px;color:#6b7280;margin-top:2px}
.section-title{font-size:12px;font-weight:bold;color:#fff;background:#2563eb;padding:3px 8px;margin-bottom:4px;text-transform:uppercase;border-radius:2px}
...
<table class="info-table">
  ...
  ${d.billingDate ? `<tr><td class="label">FATURAMENTO:</td><td colspan="3">${d.billingDate}</td></tr>` : ''}
...
${order.notes ? `<div class="section-title">Observações</div><div style="border:1px solid #ccc;padding:4px 6px;margin-bottom:6px;white-space:pre-wrap;font-size:12px">${order.notes}</div>` : ''}
<div style="margin-top:20px;text-align:center;color:#6b7280;font-size:10px;border-top:1px solid #e5e7eb;padding-top:6px">Sigma Transformadores Ltda - Pedido Interno Gerado Eletronicamente</div>
</body></html>`
